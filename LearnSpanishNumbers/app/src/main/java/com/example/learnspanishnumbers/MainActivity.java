package com.example.learnspanishnumbers;
...
//                "Your Message "+id , Toast.LENGTH_LONG).show();

        int myMusic = getResources().getIdentifier(nameId, "raw","com.example.learnspanishnumbers");
